...
import factoryImage from '../../assets/about-hero-factory.svg'
import chairmanImage from '../../assets/about-chairman.svg'
        ...
        <div className="about-chairman-intro">
          <div>
            ...
            <h2 className="about-chairman-title mb-0">
              MESSAGE FROM
              <span className="d-block">THE CHAIRMAN.</span>
            </h2>
          </div>
        ...
        <section className="about-chairman-card">
          <div className="about-chairman-copy-block">
            ...
            <p className="about-chairman-card-text mb-0">
              We started this company with no money, knowledge, or network, only strong value and
              belief. That vision helped us grow into a globally connected business. Driven by
              customer trust and reliability, we continue to improve our workforce and
              infrastructure to meet increasing industrial needs. Our goal is to become a leading
